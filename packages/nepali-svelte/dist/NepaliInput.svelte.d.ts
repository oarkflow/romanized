...
declare const NepaliInput: $$__sveltets_2_IsomorphicComponent<{
    [x: string]: any;
...
type NepaliInput = InstanceType<typeof NepaliInput>;
export default NepaliInput;
//# sourceMappingURL=NepaliInput.svelte.d.ts.map